<?php
  ...
  class Routers extends Controller
  {
      ...
      public function fetch($room = null)
      {
          if ($_SERVER['REQUEST_METHOD'] == 'POST') {
          } else {
              // No Room Entered
              ...
              $data = [
                'room' => $room,
                'history' => $this->firebaseObject->get($room),
                'routers' => $routers
            ];
