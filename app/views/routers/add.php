  ...
  <div class="row">
    <div class="col-md-6 mx-auto mb-4">
      <div class="card card-body bg-light mt-4">
          <h2>Add Router</h2>
          <p>Please fill out the form to add a router</p>
          <form action="<?php echo URLROOT; ?>routers/add" method="POST">
            ...
            <div class="row">
              <div class="col">
                <input type="Submit" value="Add Router" class="btn btn-success btn-block">
              </div>
            </div>
